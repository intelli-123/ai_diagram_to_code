...
// 🧩 Gemini: Generate valid Terraform code for AWS
...
app.post('/upload', upload.single('diagram'), async (req, res) => {
  try {
    ...
    // ✅ Clean invalid Terraform syntax before saving (skip ZIP + inline_code)
    let cleanedTerraform = terraformCode
      ...
      // ✅ Remove inline_code blocks and replace with valid placeholder
